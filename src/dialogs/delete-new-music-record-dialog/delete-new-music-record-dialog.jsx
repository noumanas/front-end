...
const DeleteNewMusicRecordDialog = ({ onClose, open, track }) => {
    ...
    return (
        ...
        >
            <DialogTitle className={classess.dialog__title}>Delete New Music Record</DialogTitle>
            <DialogContent dividers className={classess.dialog__content}>
                <DialogContentText className={classess.dialog__content__text} id="alert-dialog-description">
                    This is to confirm you that, you want to delete the New Music Record from this Artist
                </DialogContentText>
            </DialogContent>
