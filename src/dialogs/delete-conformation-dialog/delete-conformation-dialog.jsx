...
const DeleteConformationDialog = ({ onClose, open, artist }) => {
    ...
    return (
        ...
        >
            <DialogTitle className={classess.dialog__title}>Delete Conformation</DialogTitle>
            <DialogContent dividers className={classess.dialog__content}>
                <DialogContentText className={classess.dialog__content__text} id="alert-dialog-description">
                    This is to confirm you that, you want to delete the artist named {artist.name}. Are you sure you want to delete this artist?
                </DialogContentText>
            </DialogContent>
